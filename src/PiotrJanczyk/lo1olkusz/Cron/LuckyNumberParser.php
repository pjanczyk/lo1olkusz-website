...
namespace PiotrJanczyk\lo1olkusz\Cron;

require_once 'libs/simple_html_dom.php';

use Exception;
use PiotrJanczyk\lo1olkusz\Model\LuckyNumber;
...
class LuckyNumberParser
{
     ...
     * @return \PiotrJanczyk\lo1olkusz\Model\LuckyNumber|null
     */
     ...
     * @param string $text
     * @return \PiotrJanczyk\lo1olkusz\Model\LuckyNumber
